                    ...
                    <div class="col-12">
                        <div class="card mb-2">
                            <div class="card-header d-flex justify-content-between">
                                <h4 class="text-primary">فئة جديدة</h4>

                            </div>
                            <div class="card-body px-0 pt-0 ">
                                <form enctype="multipart/form-data" action=" {!! action('App\Http\Controllers\CategoryController@store') !!}" method="POST">
                                    @csrf
                                    <div class="container">
                                        ...
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label"> صورة الفئة</label>
