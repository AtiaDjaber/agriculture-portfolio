...
(function ($, window, document, Math, undefined) {
  var miSlider = function miSlider(stageEl, options) {
    //  Clone miSlider object
    var o = this; //  Initialize option defaults ------------------------------------------------------------------------
    ...
    o.init = function (stageEl, options) {
      ...
      //  Set options
      o.options = $.extend({}, o.optionsInit, options); //  Initiate elements
      ...
      o.animatedElements = o.animatedElements.add(o.slider); //  Initiate current index
      ...
      if (o.options.pause === false) {
        //  Note: 0 must return true
        o.pause = false;
      ...
      o.optionsInit.slideScaling = o.slideScaling; //  Initiate the calculated increment
      ...
      $(window).on({
        ...
        'load': function load() {
          ...
          o.slideSetup();
          o.updateNavButtons(); //  Fade in everything

          o.stage.fadeTo(600, 1); //  Autoplay slides if enabled

          o.autoplayOn(o.increment); //  Slides loaded callBack
    ...
    o.setup = function () {
      ...
      o.indexLast = o.slidesLength - 1; //  Get widths, heights, add slide class and container

      o.slides.each(function () {
        var slide = $(this); //  Add slide class to slide
      ...
      o.indexCurrent = o.normalizeIndex(o.indexCurrent); //  Set the stage ----------------------------------------------------------------------------------
      //  Set CSS
      ...
      o.stageWidth = o.stage.outerWidth(); //  Calculate slide scaling, widths, increment and slides on and off stage  ------------------
      ...
      if (x > o.slidesOnStage) {
        //  increment is positive and more than slides on stage
        o.increment = o.slidesOnStage;
      } else if (x < 0) {
        //  increment is negative and more than slides on stage
        o.increment = -o.slidesOnStage;
      ...
      o.scalingMargin = (o.slideWidth - o.scalingWidth) / 2; //  Determine the number of slides off stage

      var slidesOffStage = o.slidesLengthOrig - o.slidesOnStage; //  Clone last slidesToClone slides to beginning and first slidesToClone slides to end ---------------

      if (slidesOffStage >= 0 && o.options.slidesContinuous) {
        //  Set calculated continuous motion boolean to true
        o.slidesContinuous = true; //  Determine the number of slides to clone

        o.slidesToClone = o.slidesOnStage + Math.abs(o.increment) - 1; // Prepend last slidesToClone slides

        o.slides.slice(o.slidesLength - o.slidesToClone).clone().addClass(o.classSlideClone).removeAttr('id').prependTo(o.slider).find('*').removeAttr('id'); // Append first slidesToClone slides

        o.slides.slice(0, o.slidesToClone).clone().addClass(o.classSlideClone).removeAttr('id').appendTo(o.slider).find('*').removeAttr('id'); // Adjust indexes

        o.indexFirst = o.slidesToClone;
        o.indexLast = o.slidesLength + o.slidesToClone - 1;
        o.indexCurrent = o.indexCurrent + o.slidesToClone; // Refresh slides
      ...
      o.animatedElements = o.animatedElements.add(o.slides); //  Set the horizontal position, width and other CSS of the slider ---------------------------------
      //  Calculate the width of the slider

      o.sliderWidth = o.slideWidthCurrent + o.slideWidth * (o.slidesLength - 1) + 1; //  Set CSS of slider
    ...
    o.transition = function (indexTo, beforeTrans, afterTrans, navButtonsFadeIn) {
      ...
      if (!o.animatedElements.is(':animated') && indexTo !== o.indexCurrent) {
        ...
        var indexCurrentAdjusted = o.indexCurrent; //  Update indexes and slides if continuous and slides are out of bounds ------------------------
        ...
        var indexDiff = o.normalizeIndex(indexToAdjusted) - o.normalizeIndex(indexCurrentAdjusted); //  If adjusted indexTo != adjusted current index - do move --------------------------------------
        ...
        if (indexDiff) {
          ...
          if (o.slidesContinuous && indexCurrentAdjusted !== o.indexCurrent) {
            var slideCurrentAdjusted = o.slides.eq(indexCurrentAdjusted); //  Prepare Current slide's clone
            ...
            slideCurrentAdjusted.addClass(o.classCurrent).siblings().removeClass(o.classCurrent); //  Jump to Clone

            o.slider.css('left', o.leftOffset(indexCurrentAdjusted)); //  Reset original
          ...
          if (o.navButtons) {
            ...
            o.navButtons.fadeTo(100, navButtonsFadeIn ? o.navButtonsOpacity : 0, function () {
              ...
              function () {
                ...
                o.animateSlides(indexToAdjusted, function () {
                  if (o.stage.find(':hover').length || o.options.navButtonsShow) {
    ...
    o.animateSlides = function (indexTo, afterTrans) {
      ...
      o.slideCurrent.removeClass(o.classCurrent); //  Define the slide to move to
      ...
      if (o.slideScaling !== 100) {
        ...
        if (o.options.centerV) {
          ...
          slideTo.children().first().animate({
          ...
          o.slideCurrent.children().first().animate({
      ...
      o.slider.animate({
        ...
        complete: function complete() {
          ...
          o.slideCurrent = slideTo; //  update navList

          o.updateNavList(indexTo); //  Add current class to current slide

          o.slideCurrent.addClass(o.classCurrent).siblings().removeClass(o.classCurrent); //  Execute callbacks
    ...
    o.addNavButtons = function (element) {
      ...
      var $el = $(element); //  Construct HTML

      var navButtons = $('<div class="' + o.options.classNavButtons + '"><a href="#" class="' + o.classPrev + '">Prev</a><a href="#" class="' + o.classNext + '">Next</a></div>'); //  Apply CSS and click events to buttons
      ...
      $el.append(navButtons); //  Define cached objects
    ...
    o.addNavList = function () {
      //  Define List
      var listHtml = '<ol class="' + o.options.classNavList + '">'; //  Create each List item

      o.slides.each(function (index) {
        //  Define the text for the list item
        var itemText = index + 1; // Use header, figcaption, or img title as list item text instead
      ...
      listHtml += '</ol>'; //  Create temporary list object and add click events

      var navList = $(listHtml).on('click', 'li', function (e) {
        e.preventDefault();
    ...
    o.updateNavList = function (index) {
      if (o.navListItems.length) {
        o.navListItems.eq(index - o.indexFirst).addClass(o.classCurrent).siblings().removeClass(o.classCurrent);
      }
    }; //  Assorted functions ==============================================================================
    //  Randomizer --------------------------------------------------------------------------------------
    ...
    o.slideSetup = function () {
      o.slides.each(function (i) {
        var slide = $(this); //  Set transform origin and current width
        ...
        if (i === o.indexCurrent) {
          slide.css({
            ...
            // compensation for scaling transform
            'transform': 'scale(1)'
          }).addClass(o.classCurrent).siblings().removeClass(o.classCurrent); //  Vertically center slide if enabled
    ...
    o.getMarginTop = function (slide, dataKey) {
      var slideMarginTop = 0; //  Get height of slide container

      var height = slide.children().first().outerHeight(); //  Add negative top margin if slide height is bigger than stage height
    ...
    o.supportTransform = function (modernizrBool, element) {
      var test = false; //  User Modernizr if it exists
