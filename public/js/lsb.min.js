...
/*!*********************************!*\
  !*** ./resources/js/lsb.min.js ***!
  \*********************************/
!function (t) {
  "use strict";

  t.fn.lightspeedBox = function (e) {
    function p(t) {
    ...
    var s,
      ...
      current: null,
      images: [],
      getImagesInSet: function getImagesInSet(e) {
        var i,
            s = [],
            n = 0,
            o = e.attr("href"),
            l = e.find("img").attr("alt"),
            r = e.attr("data-lsb-group");
        r ? (i = t('.lsb-preview[data-lsb-group="' + r + '"]'), i.each(function (e, i) {
      ...
      canSwitch: function canSwitch() {
        return this.images.length > 1;
      }
    };
    !function () {
      for (var e = "", i = 0; 12 > i; i++) {
        e += '<div class="waitingicon-circle"></div>';
      }

      t("body").append('<div class="lightspeed-box"><div class="lsb-content"><header class="lsb-header"><div class="lsb-image-count"></div><div class="lsb-image-title"></div></header><div class="lsb-control-panel"><a class="lsb-control lsb-panel-button lsb-autoplay" title="Slideshow">►</a><a class="lsb-control lsb-panel-button lsb-download" download title="Download Image">&#8681;</a></div><div class="lsb-image-container"><div class="lsb-no-image-found"><div class="no-found-msg">Sorry, no image found.</div></div><img class="lsb-image lsb-noimage"></div><div class="waitingicon">' + e + '</div><div class="lsb-control lsb-close"><span class="lsb-control-text" title="Close the image">&#x2716;</span></div><div class="lsb-control lsb-prev"><span class="lsb-control-text" title="Next image">&lt;</span></div><div class="lsb-control lsb-next"><span class="lsb-control-text" title="Previous image">&gt;</span></div></div></div>'), s = t(".lightspeed-box"), s.css("z-index", a.zIndex), n = t(".waitingicon"), o = s.find(".lsb-image"), l = s.find(".lsb-image-title"), r = s.find(".lsb-image-count"), c = s.find(".lsb-no-image-found"), u = s.find(".lsb-next"), g = s.find(".lsb-prev"), d = s.find(".lsb-close"), h = s.find(".lsb-download"), f = s.find(".lsb-autoplay"), a.showDownloadButton || h.hide(), a.showAutoPlayButton || f.hide(), u.attr("title", a.locale.nextButton), g.attr("title", a.locale.prevButton), d.attr("title", a.locale.closeButton), h.attr("title", a.locale.downloadButton), c.find(".no-found-msg").text(a.locale.noImageFound), s.swipeDetector().on("swipeLeft.lsb swipeRight.lsb", function (t) {
        m.images.length > 1 && ("swipeLeft" === t.type ? k(m.nextImage()) : "swipeRight" === t.type && k(m.previousImage()));
      }), t(document).on("keyup.lightspeed-box", function (t) {
        s.hasClass("lsb-active") && (39 === t.which && m.images.length > 1 ? (t.stopPropagation(), k(m.nextImage())) : 37 === t.which && m.images.length > 1 ? (t.stopPropagation(), k(m.previousImage())) : 27 === t.which && y());
      }), u.click(function (t) {
        t.stopPropagation(), a.autoPlayback = !1, k(m.nextImage());
      }), g.click(function (t) {
        t.stopPropagation(), a.autoPlayback = !1, k(m.previousImage());
      }), f.click(function (t) {
        t.stopPropagation(), a.autoPlayback = !a.autoPlayback, a.autoPlayback ? (f.text("| |"), f.removeClass("lsb-autoplay"), f.addClass("lsb-autoplay-playing"), window.setTimeout(x, a.playbackTiming)) : (f.text("►"), f.removeClass("lsb-autoplay-playing "), f.addClass("lsb-autoplay"));
      }), h.click(function (t) {
        t.stopPropagation();
    ...
    }(), t(".lsb-preview").click(function (e) {
    ...
    function u() {
      2 === i && (i = 0, Math.abs(n) > Math.abs(o) && Math.abs(n) > e.swipeThreshold ? l.trigger(0 > n ? t.Event("swipeLeft.lsb") : t.Event("swipeRight.lsb")) : Math.abs(o) > e.swipeThreshold && l.trigger(0 > o ? t.Event("swipeUp.lsb") : t.Event("swipeDown.lsb")));
    }
